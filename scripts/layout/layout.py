...
mounting_holes = [
    [top_left.x + HOLE_OFFSET_S, top_left.y - HOLE_OFFSET_C],
    [top_right.x - HOLE_OFFSET_S, top_right.y - HOLE_OFFSET_C],

    [top_left.x + HOLE_OFFSET_S + TOP_HOLE_SPACE, top_left.y - HOLE_OFFSET_C],
    [top_right.x - HOLE_OFFSET_S - TOP_HOLE_SPACE, top_right.y - HOLE_OFFSET_C],

    [bottom_left.x + HOLE_OFFSET_S_NEG, bottom_left.y + HOLE_OFFSET_C_NEG],
    [bottom_right.x - HOLE_OFFSET_S_NEG, bottom_right.y + HOLE_OFFSET_C_NEG],
    [bottom_middle.x, bottom_middle.y + HOLE_OFFSET_C_2X],

    [bottom_left.x + HOLE_OFFSET_S_NEG + BOTTOM_HOLE_SPACE * math.cos(TILT),
     bottom_left.y + HOLE_OFFSET_C_NEG + BOTTOM_HOLE_SPACE * math.sin(TILT)],
    [bottom_right.x - HOLE_OFFSET_S_NEG - BOTTOM_HOLE_SPACE * math.cos(TILT),
     bottom_right.y + HOLE_OFFSET_C_NEG + BOTTOM_HOLE_SPACE * math.sin(TILT)],
